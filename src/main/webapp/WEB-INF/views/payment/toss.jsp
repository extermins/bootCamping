		...
		<div class="col-md-6">
			...
			<div id="requestPayment_form" class="box_section"
				...
				<div class="mb2">
					...
					<input id="orderId" class="form-control form-control-lg" type="text" value="${tossid}">
				</div>

				<div class="mb2">
					<label class="form-label" for="amount">물품명 <span class="gray">(orderName) </span><span
							class="red">필수</span></label>
					<input id="orderName" class="form-control form-control-lg" type="text" value="${sessionScope.payment.size() == 1 ? sessionScope.payment[0].name : sessionScope.payment[0].name.concat(' 외 ').concat(sessionScope.payment.size() - 1).concat('개')}">
				</div>

				<div class="mb2">
					<label class="form-label" for="amount">금액 <span class="gray">(amount) <span
							class="red">필수</span></label>
					<input id="amount" class="form-control form-control-lg" type="text" value="${totalPrice}">
					<!-- 금액 내 천단위 콤마 X -->
				</div>

				<div class="mb2">
					<label class="form-label" for="amount">구매자명 <span class="gray">(customerName)</span></label>
					<input id="customerName" class="form-control form-control-lg" type="text" value="${member.name}">
				</div>
...
<script>
	/* =================================  API KEY 세팅 ================================== */
	let clientKey = 'test_ck_P24xLea5zVANdYX1OG0rQAMYNwW6'; // [TODO] https://developers.tosspayments.com 로그인 후 API Key발급 가능
	...
	paymentData["공통"] = {
		...
		"failUrl": "https://localhost:8080/toss/fail",
		"windowTarget": "iframe",
		"taxFreeAmount": null,
